...
public class automode_three extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addData("getshippinghublevel: ", level);
        telemetry.update();
        ...
        if(level == ShippingHubLevel.LEFTSIDE){
        ...
        }else if(level == ShippingHubLevel.MIDDLE || level == ShippingHubLevel.RIGHTSIDE){
            liftmotor.setPower(1);
            Thread.sleep(4900);
            liftmotor.setPower(0);
            robot.moveLeft(motorFrontLeft, motorBackLeft, motorFrontRight, motorBackRight, 1);
    ...
    class CameraDetection extends OpenCvPipeline {
        ...
        * */
        ...
        public Mat processFrame(Mat input) {
            ...
            if ((midpercent < 17 && leftpercent < 17 )){
